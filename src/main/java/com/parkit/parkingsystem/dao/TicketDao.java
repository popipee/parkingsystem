...
public class TicketDao {
  ...
  /**
   * This method is used to update the inTime date of a specified ticket with its ID.
   *
   * @param ticket is the ticket to be updated.
   * @return a boolean which is true if the operation went well.
   */
  ...
  /**
   * This method is used to update the outTime date of a specified ticket with its ID.
   *
   * @param ticket is the ticket to be updated.
   * @return a boolean which is true if the operation went well.
   */
  public boolean updateTicketOutTime(Ticket ticket) {
    Connection con = null;
    try {
      con = dataBaseConfig.getConnection();
